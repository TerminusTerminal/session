...
<body>
    ...
    <section class="balance-section">
        <div class="balance-info">
            <span class="account-type">Regular Checking - </span>
            <span class="balance">$<?php echo number_format($account['balance'], 2); ?></span>
            <span class="balance-note">Available balance (as of today)</span>
        </div>
    </section>
    ...
    <footer class="home-footer">
        <div class="concerns-footer">
            ...
            <div class="social-icons">
                <ul>
                    <li><a class="icon-facebook social-icons" href="javascript:void(0)"></a></li>
                    <li><a class="icon-linkedin social-icons" href="javascript:void(0)"></a></li>
                    <li><a class="icon-instagram social-icons" href="javascript:void(0)"></a></li>
                    <li><a class="icon-pinterest social-icons" href="javascript:void(0)"></a></li>
                    <li><a class="icon-youtube social-icons" href="javascript:void(0)"></a></li>
                    <li><a class="icon-twitter social-icons" href="javascript:void(0)"></a></li>
                </ul>
            </div>
        </div>
    </footer>
